...
import { Filter, Search, Star, Clock, Tag, Trophy, ChevronDown, Box, Move } from 'lucide-react';
...
const mockNFTs = [
    {
        ...
        name: "Dragon Warrior",
        rarity: "Legendary",
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1737633537/Mysteria/Discover_Powerful_Legendary_Items_fgx6yj.jpg",
        level: 5,
    ...
    },
    {
        ...
        rarity: "Epic",
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1737633371/Mysteria/upgrade_nft_eewq7o.jpg",
        level: 3,
    ...
    },
    {
        ...
        rarity: "Rare",
        image: "https://res.cloudinary.com/dlotuochc/image/upload/v1737633257/Mysteria/Summon_Rare_NFTs_from_Mystical_Chests_krtidq.jpg",
        level: 2,
...
export default function CollectionPage() {
    ...
    const findNFTAtPosition = (x: number, y: number) => {
        return nfts.find(nft => {
            ...
            return x >= nftX && x < nftX + NFT_SIZE &&
                y >= nftY && y < nftY + NFT_SIZE;
        });
    };
    ...
    const isValidPosition = (x: number, y: number, nftId: number) => {
        ...
        if (x < 0 || y < 0 || x + NFT_SIZE > GRID_SIZE || y + NFT_SIZE > GRID_SIZE) {
            return false;
        }
        ...
        return !nfts.some(nft => {
            ...
            return x < nftX + NFT_SIZE && x + NFT_SIZE > nftX &&
                y < nftY + NFT_SIZE && y + NFT_SIZE > nftY;
        });
    };
    ...
    const getPreviewStyle = (x: number, y: number) => {
        ...
        const color = isValid ? 'rgba(59, 130, 246, 0.2)' : 'rgba(239, 68, 68, 0.2)';
        const borderColor = isValid ? 'rgba(59, 130, 246, 0.5)' : 'rgba(239, 68, 68, 0.5)';
                ...
                <div className="max-w-[1600px] mx-auto px-4 py-8">
                    ...
                    <div className="text-center mb-16">
                        ...
                        <p className="text-white/60 max-w-2xl mx-auto">
                            Arrange your NFTs in the mystical treasure chest.
                            Click an NFT to select it, then click an empty space to place it.
                        </p>
                    </div>
                        ...
                        <div className="lg:w-1/3 space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                >
                                    ...
                                    <ChevronDown className={`w-4 h-4 text-white/60 transition-transform ${showFilters ? 'rotate-180' : ''}`} />
                                </button>
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {Object.entries(rarityColors).map(([rarity, color]) => (
                                                        <button
                                                            ...
                                                            className={`px-4 py-2 rounded-lg border transition-colors ${selectedRarity === rarity
                            ...
                            <div className="space-y-4">
                                ...
                                {filteredNFTs.map((nft) => (
                                    <motion.div
                                        key={nft.id}
                                        className={`group relative cursor-pointer ${selectedNFT === nft.id ? `ring-2 ring-[${rarityColors[nft.rarity as keyof typeof rarityColors]}]` : ''}`}
                                        ...
                                        <div className="relative h-24 rounded-xl overflow-hidden">
                                            ...
                                            <div className="absolute inset-0 p-4 flex items-center gap-4">
                                                <div
                                                    ...
                                                    style={{
                                                        borderColor: rarityColors[nft.rarity as keyof typeof rarityColors],
                                                        backgroundColor: `${rarityColors[nft.rarity as keyof typeof rarityColors]}20`,
                                                    }}
                                                >
                                                    <Box className="w-8 h-8" style={{ color: rarityColors[nft.rarity as keyof typeof rarityColors] }} />

                                                    {/* Glow effect */}
                                                    <div
                                                        className="absolute inset-0 blur-xl opacity-50 group-hover:opacity-100 transition-opacity"
                                                        style={{
                                                            backgroundColor: rarityColors[nft.rarity as keyof typeof rarityColors],
                                                        }}
                                                    />
                                                </div>

                                                <div>
                                                    <h3 className="text-white font-medium group-hover:text-blue-500 transition-colors">{nft.name}</h3>
                                                    <p className="text-sm" style={{ color: rarityColors[nft.rarity as keyof typeof rarityColors] }}>
                                                        {nft.rarity}
                                                    </p>
                                                </div>
                                            </div>
                        ...
                        <div className="lg:w-2/3">
                            <div className="bg-white/5 border border-white/10 rounded-xl p-8">
                                <div className="relative">
                                    ...
                                    >
                                        {/* Grid Cells */}
                                        <div className="absolute inset-0 grid gap-[1px]"
                                            style={{
                                            ...
                                            {Array.from({ length: GRID_SIZE * GRID_SIZE }).map((_, index) => {
                                                ...
                                                return (
                                                    <motion.div
                                                        ...
                                                        onMouseEnter={() => selectedNFT && setHoveredCell({ x, y })}
                                        ...
                                        {nfts.map((nft) => (
                                            <motion.div
                                                ...
                                                className="absolute"
                                                style={{
                                                    width: NFT_SIZE * CELL_SIZE + (NFT_SIZE - 1) * GRID_GAP,
                                                    height: NFT_SIZE * CELL_SIZE + (NFT_SIZE - 1) * GRID_GAP,
                                                }}
                                                initial={false}
                                                animate={{
                                                ...
                                                onClick={() => handleCellClick(nft.position.x, nft.position.y)}
                                            >
                                                <div className="relative w-full h-full rounded-lg overflow-hidden group">
                                                    ...
                                                    <div
                                                        ...
                                                        style={{
                                                            background: `radial-gradient(circle at 50% 50%, ${rarityColors[nft.rarity as keyof typeof rarityColors]}40 0%, transparent 70%)`,
                                                        }}
                                                    />
                                                    ...
                                                    <div className="absolute bottom-2 left-2 right-2">
                                                        <div
                                                            ...
                                                            style={{
                                                                backgroundColor: `${rarityColors[nft.rarity as keyof typeof rarityColors]}20`,
                                                                color: rarityColors[nft.rarity as keyof typeof rarityColors],
                                                            }}
                                                        >
                                                            {nft.name}
                                                        </div>
