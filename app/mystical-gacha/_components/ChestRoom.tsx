...
export default function ChestRoom() {
    ...
    const [keyBalances, setKeyBalances] = useState<Record<ChestType['type'], number>>({
        Bronze: 0,
        Silver: 0,
        Gold: 0,
        Legend: 0,
        ...
        <div className="w-full max-w-7xl mx-auto px-4">
            ...
            <div className="text-center mb-16">
                ...
                <p className="text-white/60 max-w-2xl mx-auto">
                    Choose a chest to open and discover rare NFTs within.
                    Each chest has different drop rates for rare items!
                </p>
            </div>
                            ...
                            <div className="aspect-square relative">
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-end p-6 text-center">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <h3 className="text-xl font-medium text-white">{chest.name}</h3>
                                    </div>

                                    <p className="text-white/60 text-sm mb-4">{chest.description}</p>

                                    <div className="w-full space-y-2">
                                        <div className="flex justify-between text-sm">
                                            <span className="text-white/40">Common:</span>
                                            <span className="text-white/60">{chest.dropRates.common}%</span>
                                        </div>
                                        <div className="flex justify-between text-sm">
                                            <span className="text-white/40">Rare:</span>
                                            <span style={{ color: chest.color }}>{chest.dropRates.rare}%</span>
                                        </div>
                                        <div className="flex justify-between text-sm">
                                            <span className="text-white/40">Legendary:</span>
                                            <span className="text-purple-400">{chest.dropRates.superRare}%</span>
                                        </div>
                                    </div>
