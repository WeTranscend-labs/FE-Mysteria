...
export default function NFTUpgrade() {
    ...
    const handleSelectNFT = (nft: NFT) => {
        ...
        const currentIndex = qualities.indexOf(nft.quality);
    ...
    const calculateSuccessRate = () => {
        ...
        const qualities = ["Common", "Rare", "Epic", "Legendary", "Mythic"];
        const currentIndex = qualities.indexOf(selectedNFT.quality);
            ...
            <div className="max-w-[1600px] mx-auto px-4 py-8">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-white/60 max-w-2xl mx-auto">
                        ...
                        Higher rarity upgrades require more tokens and have lower success rates.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
                    ...
                    <div className="lg:sticky lg:top-8 z-20">
                        <h2 className="text-2xl font-semibold mb-6 text-white">Source NFT</h2>
                        ...
                        {selectedNFT && targetQuality ? (
                            <>
                                <HexagonProgress
                                    ...
                                    sourceQuality={selectedNFT.quality}
                                ...
                                <div className="w-full mt-8 space-y-6">
                                    <div className="space-y-4">
                                        <div className="flex justify-between items-center">
                                            ...
                                            <span className="text-white font-medium">+{Math.min(tokensSpent * 0.1, 100).toFixed(1)}%</span>
                                        </div>
                                        <input
                                            type="range"
                                            min="0"
                    ...
                    <div className="lg:sticky lg:top-8">
                        <h2 className="text-2xl font-semibold mb-6 text-white">Target Rarity</h2>
                                    ...
                                    <div className="aspect-[3/4] rounded-xl border border-white/10 overflow-hidden relative">
                                        ...
                                        <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
                                            <div className="text-4xl mb-4" style={{
                                                color: targetQuality === "Rare" ? "rgb(59, 130, 246)" :
                                                    targetQuality === "Epic" ? "rgb(168, 85, 247)" :
                                                        targetQuality === "Legendary" ? "rgb(245, 158, 11)" :
                                                            "white"
                                            }}>
                                                ?
                                            </div>
                                            <h3 className="text-xl font-medium text-white mb-2">Mystery {targetQuality}</h3>
                                            <p className="text-white/60 text-sm">
                                                Upgrade your NFT to unlock a random {targetQuality.toLowerCase()} item
                                            </p>
                                        </div>
                                    </div>

                                    <div className="p-4 bg-white/5 rounded-lg">
                                        <h4 className="text-white font-medium mb-2">Rarity Information</h4>
                                        <div className="space-y-2 text-sm">
                                            <div className="flex justify-between">
                                                <span className="text-white/60">Base Success Rate</span>
                                                <span className="text-white">{Math.max(10, 100 - ((["Common", "Rare", "Epic", "Legendary", "Mythic"].indexOf(targetQuality) - ["Common", "Rare", "Epic", "Legendary", "Mythic"].indexOf(selectedNFT?.quality || "Common")) * 30))}%</span>
                                            </div>
                                            <div className="flex justify-between">
                                                <span className="text-white/60">Token Bonus</span>
                                                <span className="text-blue-500">+{Math.min(tokensSpent * 0.1, 100).toFixed(1)}%</span>
                                            </div>
                                            <div className="flex justify-between">
                                                <span className="text-white/60">Final Success Rate</span>
                                                <span className="text-green-500">{calculateSuccessRate().toFixed(1)}%</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
