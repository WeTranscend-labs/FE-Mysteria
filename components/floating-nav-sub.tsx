...
const NavItem = ({ href, icon: Icon, name, isActive, index, activeIndex }: NavItemProps) => {
    return (
                ...
                <div
                    className={cn(
                        "flex h-10 cursor-pointer items-center gap-2 rounded-lg border-2 px-4 transition-all duration-300",
                        {
                            ...
                            "border-transparent hover:border-white/10 text-white/60 hover:text-white/90": !isActive,
                            "origin-top-right ease-in hover:rotate-3": index !== activeIndex,
                        }
                    )}
                >
